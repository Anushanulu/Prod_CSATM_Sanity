...
public class Step1_CreateRequest_GB {
	...
	@FindBy (xpath = ".//*[@id='content-main']/p[5]/a") private WebElement loginToContractor_Link;
	...
	@FindBy ( xpath="//button[@id='login-button']") private WebElement Signin_Button ;
	...
	@FindBy (xpath = "//*[@id=\"content-main\"]/form/table[7]/tbody/tr[2]/td[2]/select") private WebElement Core_skill_1;
	@FindBy (xpath = "//*[@id=\"content-main\"]/form/table[7]/tbody/tr[3]/td[2]/select") private WebElement Core_skill_2;
	@FindBy (xpath = "//*[@id=\"content-main\"]/form/table[7]/tbody/tr[4]/td[2]/select") private WebElement Core_skill_3;
...
//		@FindBy(id = "btn_submit")	private WebElement SubmitPasscode;
		...
		@FindBy (xpath = "//input[@id='otp']") private WebElement OTP_TextBox;
		@FindBy (xpath = "//input[@id='btn_submit']") private WebElement OTP_Submit_Button;
	...
	public void login() throws IOException, InterruptedException{
		...
		cred_login.click();
		System.out.println("clicked on new sign in button");
...
// 		try {
 			...
 			//Totp_Link.click();
// 			String otpKeyStr = "OMPZZ2UCFBFTGRHQ"; // <- this 2FA secret key for csatestus2@c25a0161.toronto.ca.ibm.com
...
// 		}	
	...
	//switch instance
		...
		{
			WebDriverWait wait03 = new WebDriverWait(driver, 600);
		...
		public void Change_Requestor()
		{
			...
			email_txtbox.sendKeys("lajos.kosa@ibm.com");
			go_btn.click();
			//Shutterbug.shootPage(driver, ScrollStrategy.WHOLE_PAGE).save(System.getProperty("user.dir") + "\\src\\test\\resources\\Screens\\UK");
			name_select.click();
			//Shutterbug.shootPage(driver, ScrollStrategy.WHOLE_PAGE).save(System.getProperty("user.dir") + "\\src\\test\\resources\\Screens\\UK");
