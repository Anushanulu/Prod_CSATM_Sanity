...
// 		try {
 			...
 			//Totp_Link.click();
// 			String actualString1 = driver.findElement(By.xpath("//*[@id='header_text']")).getText();
// 		String expectedString1 = "Enter your passcode";
// 		Assert.assertEquals(actualString1, expectedString1);
// 			//Assert.assertEquals("Enter your passcode", driver.findElement(By.xpath("//*[@id='header_text']")).getText());
// 			String otpKeyStr = "OMPZZ2UCFBFTGRHQ";
...
// 		}	
  ...
  {
  	WebDriverWait wait01 = new WebDriverWait(driver, 600);
	...
	public void Select_Requestor(){
		...
		ext_Email.sendKeys("pattkris@in.ibm.com");
		...
		driver.findElement(By.linkText("Pattela H Krishna")).click();
 ...
 //driver.switchTo().alert().accept();
  ...
  
  {
		...
		s2.selectByVisibleText("6G Standard");
